...
API_CONTAINER_NAME = "personalweb"

def _apiContainerRunning():
    is_running = subprocess.run(f"docker ps", shell=True, capture_output=True, text=True).stdout.find('personalweb') > 0
